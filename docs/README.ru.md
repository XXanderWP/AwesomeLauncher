...
- Автоустановка Java, Minecraft, Fabric/NeoForge и файлов сборки
- Отдельное хранение пользовательских модов
- Онлайн сервера на главном экране
- Запуск лаунчера даже при временной недоступности файлового сервера сборки
- Скачанные инстансы остаются видимыми как архивные, пока вы не удалите их сами
- Архивный инстанс можно запустить: кнопка «Играть» жёлтая и не подключает к серверу

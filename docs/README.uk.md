...
- Автоустановка Java, Minecraft, Fabric/NeoForge і файлів збірки
- Окреме зберігання користувацьких і перевірених модів збірки
- Онлайн сервера на головному екрані
- Запуск лаунчера навіть за тимчасової недоступності файлового сервера збірки
- Завантажені інстанси лишаються видимими як архівні, доки ви не видалите їх самі
- Архівний інстанс можна запустити: кнопка «Грати» жовта і не підключає до сервера
